...
async ApplicantJobsDefault(applicantIndustry: IndustriesFeilds,applicantDegrees: Degrees[],applicantSkills: string[],queryParameters: JobQueryParameters) 
{
  ...
  const projection = {requirements: 0,description: 0,currency: 0,minYears: 0,maxYears: 0,maxSalary: 0,minSalary: 0,city: 0,country: 0,createdBy: 0,updatedBy: 0,createdAt: 0,isActive: 0,status: 0,mangerAlert: 0,hrAlert: 0,hrAlertNote: 0,__v: 0};

  const options = { skip: skip, limit: limit, populate: { path: "companyId", select: "companyname _id logo.URL" } };
